...
class AuthController extends GetxController implements GetxService {
  ...
  Future<ResponseModel> login(String phone, String password) async {
    ...
    _isLoading = false;
      ...
      if (response.body['zone_wise_topic'] != null)
        authRepo.saveUserToken(response.body['token'], true,
            zoneTopic: response.body['zone_wise_topic'].toString());
      else
        authRepo.saveUserToken(response.body['token'], false);
