...
class AppConstants {
  static const String APP_NAME = "السوق المباشر للعامل";
  static const double APP_VERSION = 5.4;
  static const String UserId = "UserId";
  static const String POST_COMMENTS = '/api/v1/services/comment';
  ...
  static const String LATEST_ORDERS_URI = '/api/v1/delivery-man/latest-orders/';
  static const String RECORD_LOCATION_URI =
      '/api/v1/delivery-man/record-location-data';
  static const String PROFILE_URI = '/api/v1/delivery-man/profile';
  ...
  static const String ORDER_DETAILS_URI = '/api/v1/delivery-man/order-details';
  ...
  static const String NOTIFICATION_URI = '/api/v1/delivery-man/notifications/';
