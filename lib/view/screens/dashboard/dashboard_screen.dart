...
import 'package:efood_multivendor_driver/view/screens/posts/all_users.dart';
import 'package:efood_multivendor_driver/view/screens/posts/posts_screen.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  // getShared() async {
  //   if (sharedPreferences.getBool("isDeliver")) {
  //     setState(() {
  ...
  void initState() {
    //getShared();
    print("IsDeliver + ${!CacheHelper.getData(key: "isDeliver")}");
    super.initState();
    _pageIndex = widget.pageIndex;
    _pageController = PageController(initialPage: widget.pageIndex);

    _screens = [
      CacheHelper.getData(key: "isDeliver") ?HomeScreen():PostsScreen(),
      OrderRequestScreen(onTap: () => _setPage(0)),
      CacheHelper.getData(key: "isDeliver") ? OrderScreen() : AllUsersScreen(),
      ProfileScreen(),
    ];
    ...
    FirebaseMessaging.onMessage.listen((RemoteMessage message) {
      ...
      // }
      print("HelloMessageListen");
      print("onMessageData: ${message.data.toString()}");
      print("onMessageNotif: ${message.notification.title}");
                  ...
                  child: Row(children: [
                    BottomNavItem(
                       isimg: true,
                        ...
                        onTap: () => _setPage(0)),
                    if (CacheHelper.getData(key: "isDeliver") == true)
                      BottomNavItem(
